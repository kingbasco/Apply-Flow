...
function ScreeningReviewModal({row,onClose}:{row:ScreeningRow;onClose:()=>void}){
 const [data,setData]=useState<ScreeningReviewData|null>(null);const [loading,setLoading]=useState(true);const [error,setError]=useState('');const [aiRunning,setAiRunning]=useState(false);const [aiError,setAiError]=useState('');
