...
function App() {
  ...
  async function deleteApplication(application:Application) {
    ...
    const confirmed=window.confirm('Delete “'+application.name+'”? This will permanently delete the programme, its form versions, questions, applicants and submissions. This action cannot be undone.')
    if(!confirmed)return
